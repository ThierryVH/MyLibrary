 ...
 */
final class Version20190208174839 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book ADD user_id INT DEFAULT NULL, ADD category_id INT NOT NULL, ADD image_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book DROP user_id, DROP category_id, DROP image_id');
    }
}
